...
*c_diarrhea Child with diarrhea in last 2 weeks
	    gen c_diarrhea=(h11 ==2) 						/*symptoms in last two weeks*/
		replace c_diarrhea=. if h11  ==8| h11  ==. 
					 
		gen ccough=(h31  ==2) 
		replace ccough=. if h31  ==8| h31  ==. 
					  
*c_treatdiarrhea Child with diarrhea receive oral rehydration salts (ORS)
		cap gen h13b  =. 
		gen c_treatdiarrhea=(h13  ==2) 	if c_diarrhea == 1							/*ORS for diarrhea*/
		replace c_treatdiarrhea=. if (h13  ==8| h13  ==.)
				
		
*c_diarrhea_hmf	Child with diarrhea received recommended home-made fluids
        gen c_diarrhea_hmf=(h14  ==2) if c_diarrhea == 1			/* home made fluid for diarrhea*/
		replace c_diarrhea_hmf=. if h14  ==8 | h14  ==. 
...
*c_diarrhea_pro	The treatment was provided by a formal provider (all public provider except other public, pharmacy, and private sector)
	...
	gen c_diarrhea_pro = 0 if c_diarrhea == 1
		...
		if inlist(name,"Benin2017") {
			global h12 "h12a h12b h12c h12d h12e h12f h12g h12j h12m h12n h12o h12p h12z"
		}
...
*c_treatARI/c_treatARI2	   Child with acute respiratory infection (ARI) /ARI2 symptoms seen by formal provider
		...
		if inlist(name,"Benin2017") {
			global h32 "h32a h32b h32c h32d h32e h32f h32j h32l h32m h32n h32o h32z"
		}
